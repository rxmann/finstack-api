...
public class DashboardController {
    ...
    public ResponseEntity<DashboardResponseDTO> getDashboardAnalytics (@Valid @RequestBody DashboardRequestDTO requestDTO) {
        Optional<DashboardResponseDTO> result = this.dashboardAnalyticsService.getDashboardAnalytics(requestDTO);
        return result
